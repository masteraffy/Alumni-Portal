            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <input type ="text"  required name="Name" class="form-control" placeholder="Ex: Bachelor of Science in Computer Science">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        <label>Course Abbv:</label>                          
                        <input type ="address"  required name="address" class="form-control text-uppercase" placeholder="Ex: BSCS">     
